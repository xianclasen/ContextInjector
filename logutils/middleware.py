# This middleware is designed to add structured logging of JSON-RPC-over-HTTP (MCP) 
# traffic at the /mcp endpoint for observability and debugging.
# It captures incoming requests and outgoing responses, sanitizes the JSON-RPC
# payloads to limit field sizes, and logs relevant metadata including request IDs,
# client IPs, HTTP methods, paths, status codes, and durations.
